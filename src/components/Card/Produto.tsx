...
interface IProdutosProps {
  header: string;
  borda: { id: number, nome: string, descricao: string, imagem: string }[] | null;
...
function Produto({ header, produtos,modalAberto, montar, sinalOpenFrom, borda }: IProdutosProps) {
    ...
    <div className="">
       ...
       {modal ? (
        <ProdutoModal
          ...
          borda={borda || []}  // Passando borda corretamente
