...
export default function ProdutoModal(props: PropsModal) {
    ...
    const [bordaSelecionada, setBordaSelecionada] = useState<string | null>(null); // Adicionando o estado para borda
    let valorTotal = props.produto.valor * quantidade;

    // Função para montar o pedido
    function montarPedido() {
        const pedidoMontado = {
            id: props.produto.id,
            nome: props.produto.nome,
            descricao: props.produto.descricao,
            borda: bordaSelecionada || null,  // Se bordaSelecionada for null ou string, atribui null
            observacao,
            quantidade,
    ...
    // Função para salvar o pedido no local
    ...
    // Captura as observações do textarea
                                        ...
                                        {props.borda.map((borda) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-2">
                                                    <img className="w-12 h-12 rounded-lg" src={borda.imagem} alt="" />
                                                    <div>
                                                        <h3>{borda.nome}</h3>
